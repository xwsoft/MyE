...
public class MainActivity extends TabActivity implements OnClickListener {
	...
	private void prepareIntent() {
		mHomeItent = new Intent(this, HouseListActivity.class);
		mChannelIntent = new Intent(this, ThermostatActivity.class);
		mAccountIntent = new Intent(this, GuideActivity.class);
		mSearchIntent = new Intent(this, GuideActivity.class);
		mMoreIntent = new Intent(this, LoginActivity.class);
	}
